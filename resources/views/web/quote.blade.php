                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <div class="row">
                                <div class="form-group col-lg-4">
                                    ...
                                    {{-- <input type="number" name="rooms" placeholder="Number of Rooms" class="c-form-email form-control" id="form-room" required> --}}
                    ...
                    <div class="response-div" id="response-div" style="display: none;">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-4">
                                ...
                                {{-- <button class="btn btn-danger" id="back">Contact Sales Person</button> --}}
                                
                                {{-- <button class="btn" id="request_quote"> Contact Sales Person</button> --}}
                                ...
                                {{-- <div class="form-group col-lg-4">
                                <button class="btn btn-danger" id="request_quote"> Request Quote</button>
                                </div> --}}
                        </div>
